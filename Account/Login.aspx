<%@ Page Title="Accedi" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="Login.aspx.cs" Inherits="Account_Login" Async="true" %>
        ...
        <div class="col-md-8">
            <section id="loginForm">
                ...
                <p>
                    ...
                    se non si dispone di un account locale.
                </p>
            </section>
        </div>
