...
<div id="sfondo" class="container" style="clear:both; margin: 0px auto; width: 1350px; text-align: center; background-color:cornsilk; border-width: 6px; border-radius: 4px; height:auto; box-sizing: border-box; ">
    ...
    <div id="colonna1" style="float:left; width: 430px; height: auto; margin-left: 200px;">
        ...
        <table border="0" style="border: medium solid #1F5DB2; border-radius: 6px; padding: 10px; box-sizing:padding-box;">
            ...
            <tr>
                <td class="col1"></td>
                <td class="col1"></td>
                <td class="col3a" colspan="3" style="background-color: #fcd081; font-size: medium; font-weight: bold; color: #000000; padding: 3px;">Ricerca per nome<br /></td>
                <td class="col1">&nbsp;</td>
            </tr>
            <tr>
                <td class="col1">&nbsp;</td>
            ...
            <tr>
                ...
                <td class="col3a">&nbsp;</td>
                <td class="col1">&nbsp;</td>
                <td class="colimput" style="margin: 0px auto; text-align: left;">&nbsp;</td>
                <td class="col1">&nbsp;</td>
            </tr>
            <tr>
                <td class="col1"></td>
    ...
    <div id="scelterapide" style="padding-left:10px; margin: 0px; border-radius: 6px;">
        <table border="0" style="border: medium solid #1F5DB2; border-radius: 6px; padding: 10px; box-sizing:padding-box;">
            ...
            <tr>
                <td class="col1"></td>
                <td class="col1"></td>
                <td colspan="3" class="centra"><asp:Button ID="idSettimanaprossima" runat="server" Text="settimana prossima" Align="left" BackColor="#FFB94F" Width="202px" EnableTheming="True" Height="30px" class="bradius" CommandArgument="prossima" OnCommand="cbRapido_Command"/></td>
                <td class="col1"></td>
            </tr>
        </table>
    </div>
    ...
    <div style="padding-left:10px; width: 500px; height: auto; float:left; margin: 0px auto; border-radius: 6px;">
            ...
            <tr>
                <td class="col1"></td>
                <td colspan="4" style="background-color: #fcd081; font-size: medium; font-weight: bold; color: #000000; padding: 3px;">Ricerca per targa, numero, data, sede<br /></td>
                <td class="col1"></td>
                <td class="col1"></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="col1"></td>                
                <td class="auto-style3">Data Fine</td>
                <td class="col1"></td>
                <td class="col1"></td>
            </tr>
            <tr>
                <td class="col1"></td>
                <td class="col1"></td>
                <td class="col3"><asp:Calendar ID="cldDA" runat="server" BackColor="White" BorderColor="#999999" Caption="Seleziona giorno di inizio" CellPadding="4" DayNameFormat="Shortest" Font-Names="Verdana" Font-Size="9pt" ForeColor="Black" width="200px"></asp:Calendar></td>
                <td class="col1"></td>
                <td class="auto-style3"><asp:Calendar ID="cldA" runat="server" BackColor="White" BorderColor="#999999" Caption="Seleziona giorno di fine" CellPadding="4" DayNameFormat="Shortest" Font-Names="Verdana" Font-Size="9pt" ForeColor="Black" width="200px"></asp:Calendar></td>
                <td class="col1"></td>
                <td class="col1"></td>
            </tr>
             <tr>
    ...
    <div style="clear: both; margin: 0px auto; margin-top: 25px; text-align: center; width:800px">
        ...
        <div style="width: 400px; margin: 0px auto; float: right;">
            <asp:Button ID="cbReset" runat="server" Text="Reset" Align="center" BackColor="#fcd081" Width="150px" EnableTheming="True"  Height="30px" OnClick="cbReset_Click"  />
        </div>
    </div>
    </asp:Panel>
...
<div style="clear: both; margin: 0px auto">
    <asp:Panel ID="Panel1" runat="server" Visible="true" style="clear: both; margin: 0px auto; width: 1350px">
        ...
        <asp:Button ID="bSalvacsv" runat="server" Text="Salva in formato .csv" OnClick="bSalvacsv_Click" Visible="false"/>
        <asp:GridView ID="gwPrenotazioni" runat="server"  AutoPostBack="true" AutoGenerateColumns="false" Visible="false" AllowSorting="True"
            ...
            <asp:TemplateField>
            <HeaderTemplate>
                <asp:LinkButton ID="LinkButtonMarca" runat="server" Text="Marca, modello" CommandName="Sort" CommandArgument="marca, modello" Width="295px" HorizontalAlign="left" Wrap="true" color="Orange" linkcolor="white" linkvisitedcolor="white" DisabledLinkColor="white" LinkBehavior="white" style="color: white;"></asp:LinkButton>
            </HeaderTemplate>                            
            <ItemTemplate>
