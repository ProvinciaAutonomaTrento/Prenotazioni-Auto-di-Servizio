 ...
 * 
 */--%>
<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="schedamodello.aspx.cs" Inherits="schedamodello" %>
...
<div class="centra-text" style="font-size: 22px; height: 22px;">SCHEDA MODELLI</div><br /><div class="hrbianca"></div>
...
<div class="container" style="background-color:cornsilk; border-radius: 4px; height:auto;">
    <div style="clear:both;  width: 200px;text-align: left; float: left;">Seleziona modello</div>
    ...
    <a href="menu.aspx?l=modelli"><img src="img/home.png" alt="home page"/></a>
