...
public partial class registro_flotte : System.Web.UI.Page
{
    ...
    public static user utenti = new user(); // attenzione.... da cambiare assolutamente
    public string idus ="";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)  // SOLO LA PRIMA VOLTA CHE CARICO LA PAGINA.... vedi comando in accessi o altro
        {
            ...
            idus = Session["iduser"] != null ? Session["iduser"].ToString() : "";
            LeggiUbi(idus);
    ...
    protected void LeggiUbi(string id)    // devo leggere la tabella ubicazini
    {
        msg = "";
