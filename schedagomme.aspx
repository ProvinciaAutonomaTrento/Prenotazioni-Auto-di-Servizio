<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="schedagomme.aspx.cs" Inherits="schedagomme" %>
...
<div class="centra-text" style="font-size: 22px; height: 22px;">SCHEDA PNEUMATICI</div><br /><div class="hrbianca"></div>
...
<div class="container" style="background-color:cornsilk; border-radius: 4px; height:auto;">
    <div style="clear:both;  width: 200px;text-align: left; float: left;">Seleziona pneumatico</div>
    ...
    <div style="text-align: right; width: 200px; float: left;">
        <asp:Button ID="bInsert" runat="server" Text="Aggiungi nuova pneumatico" OnClick="bInsert_Click"  style="float: left; width: 180px;" />
    </div>
    <a href="menu.aspx?l=dotazioni"><img src="img/home.png" alt="home page"/></a>
    <div style="clear: both;"> </div>
    <p></p>
    <div style="text-align: left; width: 200px; float:left;">Pneumatico</div>
